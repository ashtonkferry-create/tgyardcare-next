...
Please contact me to discuss options and pricing.`
  ...
  // Careers Application
  'careers': {
    title: 'Career Opportunity Application',
    message: `Hello, I am interested in career opportunities with TotalGuard Yard Care. I would like to apply for a position and learn more about available roles.`
  },

  // Full Season Contract
  'full-season': {
    title: 'Full Season Property Care',
...
export function getServiceTemplate(serviceKey: string): { title: string; message: string } | null {
  return serviceTemplates[serviceKey] || null;
}
