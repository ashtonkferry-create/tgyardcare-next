...
export const SERVICE_CONFIGS: Record<string, ServiceSchemaConfig> = {
  ...
  'snow-removal': {
    ...
    longDescription: 'TotalGuard Yard Care provides automatic snow removal triggered by accumulation thresholds. We handle driveways, walkways, front steps, and back patio access. Ice melt applied to all surfaces. Dispatch begins at 2 inches of snowfall.',
  ...
  'leaf-removal': {
    ...
    longDescription: 'TotalGuard Yard Care removes all leaves from lawn areas, garden beds, and hard surfaces. We use commercial backpack blowers and vacuums to ensure thorough cleanup. Leaves are bagged and removed from property or mulched in place per your preference.',
  ...
  'gutter-cleaning': {
    ...
    longDescription: 'TotalGuard Yard Care cleans gutters by hand and with vacuum systems. All debris is removed from gutters and downspouts. We flush every downspout to verify clear drainage and inspect for loose hangers or damage. Before and after photos provided.',
  ...
  aeration: {
    ...
    longDescription: 'TotalGuard Yard Care uses commercial core aerators to extract 3-inch plugs across your entire lawn. Cores are left on the surface to break down naturally. Aeration dramatically improves water, air, and nutrient penetration to roots. Pairs perfectly with fall overseeding.',
  ...
  'fall-cleanup': {
    ...
    longDescription: 'TotalGuard Yard Care performs a comprehensive fall preparation: final mowing at recommended winter height, complete leaf removal from all areas, garden bed cleanup, cutting back perennials, and hauling all debris. Your property is buttoned up before the first freeze.',
  ...
  mulching: {
    ...
    longDescription: 'TotalGuard Yard Care installs premium double-shredded hardwood mulch to a depth of 3 inches in all garden beds. Old mulch is removed or redistributed as needed. Edges are crisp-cut for a clean finish. Mulch suppresses weeds, retains moisture, and gives beds a polished look.',
  ...
  'garden-beds': {
    ...
    longDescription: 'TotalGuard Yard Care maintains garden beds with hand-weeding, edging along turf borders, deadheading spent blooms, and debris removal. We keep beds tidy throughout the growing season so your landscape always looks intentional and maintained.',
  ...
  pruning: {
    ...
    longDescription: 'TotalGuard Yard Care prunes shrubs and small ornamental trees for shape, health, and clearance. We remove dead, crossing, and rubbing branches, thin dense growth for airflow, and shape plants to their natural form. Timing is matched to species for optimal results.',
  ...
  weeding: {
    ...
    longDescription: 'TotalGuard Yard Care removes weeds by hand from garden beds and lawn edges. We pull to the root and dispose of all material off-site. Recurring visits prevent re-establishment. Pairs with our mulching service for maximum suppression.',
  ...
  herbicide: {
    ...
    longDescription: 'TotalGuard Yard Care applies professional-grade herbicides with licensed applicators. Pre-emergent applications in spring prevent crabgrass and annual weed germination. Post-emergent treatments target broadleaf weeds in turf. Spot treatments available for beds.',
  ...
  'gutter-guards': {
    ...
    longDescription: 'TotalGuard Yard Care installs micro-mesh and aluminum gutter guards that block leaves, pine needles, and debris while allowing water to flow freely. Correctly installed guards dramatically reduce the frequency of gutter cleanings and protect your fascia from water damage.',
