  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#052e16' }}>
        ...
        >
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-lg font-bold text-white">Get Your Leaf Removal Quote</h2>
            </div>
      ...
      <CrossSellGrid
        ...
        subheading="Many Madison homeowners combine leaf removal with these related fall services:"
        items={[
          { href: "/services/fall-cleanup", title: "Full Fall Cleanup", desc: "Complete property winterization", price: "$150/visit" },
