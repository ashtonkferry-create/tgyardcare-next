  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col" style={{ background: '#020810' }}>
          ...
          >
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h2 className="text-lg font-bold text-white">Get Your Snow Removal Quote</h2>
              </div>
        ...
        <div className="order-[17] md:order-none">
          <section className="py-16" style={{ background: 'rgba(255,255,255,0.01)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
            <div className="container mx-auto px-4 max-w-5xl">
              <h2 className="text-3xl font-bold text-white mb-3" style={{ fontFamily: 'var(--font-display)' }}>
                We Provide Snow Removal Across Dane County
              </h2>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                {[
                  ...
                  <Link
                    key={city.slug}
                    href={`/snow-removal-${city.slug}-wi`}
        ...
        <div className="order-[18] md:order-none">
