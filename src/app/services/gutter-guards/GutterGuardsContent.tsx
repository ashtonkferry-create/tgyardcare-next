...
export default function GutterGuardsContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative isolate" style={{ background: '#052e16' }}>
        ...
        >
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-lg font-bold text-white">Get Your Gutter Guards Quote</h2>
            </div>
      ...
      ════════════════════════════════════════════════════════════════════ */}
      <CrossSellGrid
        heading="Complete Home Protection"
        subheading="Gutter guards are one part of protecting your home from water damage:"
        items={[
          { href: "/services/gutter-cleaning", title: "Gutter Cleaning", desc: "One-time cleaning before guard installation or if you're not ready for guards yet", price: "$135" },
          { href: "/services/fall-cleanup", title: "Fall Cleanup", desc: "Comprehensive fall property prep including leaf removal", price: "$150/visit" },
        ]}
      />
      ...
      <section className="py-16" style={{ background: 'rgba(255,255,255,0.01)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="container mx-auto px-4 max-w-5xl">
          <h2 className="text-3xl font-bold text-white mb-3" style={{ fontFamily: 'var(--font-display)' }}>
            We Provide Gutter Guard Installation Across Dane County
          </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            {[
              ...
              <Link
                key={city.slug}
                href={`/gutter-guard-installation-${city.slug}-wi`}
