...
export default function FallCleanupImportanceContent() {
  return (
    <div className="min-h-screen bg-background">
      <ArticleSchema title="Why Fall Cleanup Matters for Your Madison Lawn" description="Learn why fall yard cleanup is essential for a healthy lawn in Wisconsin" slug="fall-cleanup-importance" datePublished="2025-09-20" dateModified="2026-02-15" />
      <WebPageSchema name="Why Fall Cleanup Matters" description="The importance of fall yard cleanup in Madison, WI" url="/blog/fall-cleanup-importance" />
      <Navigation />
