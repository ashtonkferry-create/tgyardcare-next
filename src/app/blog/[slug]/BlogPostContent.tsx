...
export default function BlogPostContent({ slug }: { slug: string }) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <ArticleSchema title={post.title} description={post.meta_description || post.excerpt} slug={post.slug} datePublished={post.published_at} dateModified={post.published_at} />
      <WebPageSchema name={post.title} description={post.meta_description || post.excerpt} url={`/blog/${post.slug}`} />
      <Navigation />
