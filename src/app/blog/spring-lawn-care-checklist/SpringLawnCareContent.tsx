...
export default function SpringLawnCareContent() {
  return (
    <div className="min-h-screen bg-background">
      <ArticleSchema title="Spring Lawn Care Checklist for Madison Homeowners" description="Complete guide to spring lawn preparation in Wisconsin" slug="spring-lawn-care-checklist" datePublished="2025-03-15" dateModified="2026-03-01" />
      <WebPageSchema name="Spring Lawn Care Checklist" description="Complete spring lawn care guide for Madison, WI" url="/blog/spring-lawn-care-checklist" />
      <Navigation />
