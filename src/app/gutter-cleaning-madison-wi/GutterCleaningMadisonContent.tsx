...
export default function GutterCleaningMadisonContent() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <ServicePageSchemas slug="gutter-cleaning" faqs={faqs} />
      <LocationPageSchemas citySlug="madison" faqs={[]} />
      <WebPageSchema name="Gutter Cleaning in Madison, WI" description="Professional gutter cleaning services for Madison homeowners" url="/gutter-cleaning-madison-wi" />
