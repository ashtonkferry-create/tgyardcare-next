  ...
  return (
    <div className="min-h-screen" style={{ background: '#052e16' }}>
      ...
      <LocationPageSchemas citySlug="cottage-grove" faqs={[
        { question: `How much does lawn care cost in ${cityName}?`, answer: `Most ${cityName} residential properties pay $50-$85 per mowing visit depending on lot size. Full-service seasonal packages range from $150-$400/month.` },
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex items-center gap-6 mb-10 flex-wrap">
              ...
              <div className="flex items-center gap-2 text-white">
                ...
                <span className="font-bold">16 Cottage Grove Families</span>
              </div>
            </div>
