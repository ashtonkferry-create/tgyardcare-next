  ...
  return (
    <div className="min-h-screen" style={{ background: '#052e16' }}>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "Waunakee, WI", url: "https://totalguardyardcare.com/locations/waunakee" }
      ]} />
      <WebPageSchema name="Lawn Care in Waunakee, WI" description="Professional lawn care services in Waunakee, WI" url="/locations/waunakee" />
      ...
      <section className="py-20" style={{ background: '#0a3520' }}>
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="rounded-2xl p-8 md:p-12 text-white" style={{ background: 'linear-gradient(135deg, #0a3520 0%, #052e16 100%)' }}>
