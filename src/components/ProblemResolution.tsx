...
export function ProblemResolution({ variant = "full", className }: ProblemResolutionProps) {
  if (variant === "compact") {
    return (
      <div className={cn(
        "bg-white/[0.06] rounded-xl p-5 border border-white/[0.08]",
        className
      )}>
  ...
  return (
    <section className={cn("py-10 md:py-14 bg-white/[0.04]", className)}>
                ...
                <div key={idx} className="relative">
                  ...
                  <div className="text-center">
                    ...
                    <div className="relative inline-flex mb-3">
                      <div className="w-14 h-14 rounded-2xl bg-white/[0.08] border border-white/[0.08] flex items-center justify-center shadow-sm">
                    ...
                    <p className="text-[10px] text-white/40 mt-1 uppercase tracking-wide">{step.timing}</p>
                  </div>
                </div>
              );
            })}
