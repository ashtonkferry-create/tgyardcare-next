...
export function SummerHero() {
  ...
  const { containerRef, getLayerStyle, getTiltStyle } = useMouseParallax();
  ...
  return (
    <section ref={containerRef as React.RefObject<HTMLElement>} className="relative bg-[#1a3a2a] overflow-hidden">
      {/*
        VIDEO SWAP SLOT:
      ...
      */}
      ...
      <div className="min-h-[500px] sm:min-h-[550px] lg:min-h-[650px]">
        ...
        {/* Static background image — parallax layer */}
        <div className="absolute inset-0" style={getLayerStyle(3)}>
          <Image
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none motion-reduce:hidden" style={getLayerStyle(8)}>
        ...
        {/* AmbientParticles — replaces old inline dots/sparkles — parallax layer */}
        <div className="absolute inset-0 pointer-events-none motion-reduce:hidden" style={getLayerStyle(12)}>
        ...
        {/* Main Content — scroll-driven exit */}
