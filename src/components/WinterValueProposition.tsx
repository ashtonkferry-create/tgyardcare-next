...
export function WinterValueProposition() {
  ...
  return (
    <section ref={sectionRef} className="py-16 md:py-24 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          ...
          >
            <div className="bg-gradient-to-br from-emerald-950/50 via-slate-800/50 to-slate-900/50 rounded-2xl p-6 md:p-8 border border-emerald-500/20 shadow-xl animate-sway-right motion-reduce:animate-none animate-frost-glow hover:border-emerald-400/40 hover:shadow-emerald-500/10 hover:shadow-lg transition-all">
              <div className="flex items-center gap-3 mb-6">
