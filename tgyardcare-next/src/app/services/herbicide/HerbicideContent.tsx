          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <p className="text-base md:text-lg text-muted-foreground">
                <strong className="text-foreground">Ideal for:</strong> Homeowners battling persistent weeds like dandelions, crabgrass, and clover. Perfect for lawns that need both elimination of existing weeds and prevention of new ones.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-2xl mx-auto">
              <GlassCard variant="accent" hover="glow" className="text-center p-8 md:p-10">
                ...
                <div className="flex items-baseline justify-center gap-1 mb-4">
                  ...
                  <span className="text-muted-foreground text-lg ml-1">/application</span>
                </div>
