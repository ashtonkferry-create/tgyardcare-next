              ...
              <GlassCard hover="glow" className="h-full">
                ...
                <ul className="space-y-2.5 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong className="text-foreground">Book:</strong> September-October for best availability</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
                    <span><strong className="text-foreground">First visit:</strong> Late October after initial leaf drop</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
                    <span><strong className="text-foreground">Final visit:</strong> Mid-November before first major snow</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
                    <span><strong className="text-foreground">Window:</strong> About 4-6 weeks from first to final cleanup</span>
                  </li>
                </ul>
              </GlassCard>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2}>
              <GlassCard hover="glow" className="h-full">
                ...
                <ul className="space-y-2.5 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
                    <span><strong className="text-foreground">Standard:</strong> 1-2 visits for most properties</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
                    <span><strong className="text-foreground">Oak-heavy:</strong> 2-3 visits as oaks drop late into November</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
                    <span><strong className="text-foreground">Gutter cleaning:</strong> Included with first or final visit</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
                    <span><strong className="text-foreground">Annual service:</strong> Every fall for optimal lawn health</span>
                  </li>
                </ul>
              </GlassCard>
            </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="max-w-2xl mx-auto">
              <GlassCard variant="accent" hover="glow" className="text-center p-8 md:p-10">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Madison-Area Fall Cleanup Pricing</h2>
