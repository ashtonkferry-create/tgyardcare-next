...
# Pre-populated expense data (sorted by date)
EXPENSES_DATA = [
    (date(2026, 1, 10), "Phone/Communications", "Quo phone app", 19.59, "ACH/Bank", "Monthly", "Yes", "Line 25 - Utilities"),
    (date(2026, 1, 10), "Software/SaaS", "Lovable Website Builder", 15.00, "Credit Card", "Monthly", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 1, 10), "Software/SaaS", "Porkbun Domains", 22.00, "Credit Card", "Annual", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 1, 15), "Training/Education", "Pearson VUE exam", 45.00, "Credit Card", "One-Time", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 1, 15), "Licensing/Permits", "License application fee", 45.00, "Check", "One-Time", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 1, 20), "Insurance", "Pekin Liability Insurance", 86.00, "ACH/Bank", "Annual", "Yes", "Line 15 - Insurance"),
    (date(2026, 1, 20), "Software/SaaS", "Lovable Website Builder", 12.50, "Credit Card", "Monthly", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 1, 25), "Equipment", "Monitor", 105.00, "Credit Card", "One-Time", "Yes", "Line 22 - Supplies"),
    (date(2026, 1, 30), "Software/SaaS", "Chat subscription", 20.00, "Credit Card", "Monthly", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 2, 1), "Software/SaaS", "Claude Code", 100.00, "Credit Card", "Monthly", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 2, 1), "Software/SaaS", "Brevo marketing", 9.00, "Credit Card", "Monthly", "Yes", "Line 8 - Advertising"),
    (date(2026, 2, 1), "Software/SaaS", "n8n", 24.00, "Credit Card", "Monthly", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 2, 1), "Phone/Communications", "Twilio", 20.00, "Credit Card", "Monthly", "Yes", "Line 25 - Utilities"),
    (date(2026, 2, 1), "Marketing/Advertising", "Reviews ($5/per)", 45.00, "Venmo", "One-Time", "Yes", "Line 8 - Advertising"),
    (date(2026, 2, 1), "Software/SaaS", "Lovable Website Builder", 30.00, "Credit Card", "Monthly", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 2, 9), "Phone/Communications", "Quo (Biz phone)", 22.01, "ACH/Bank", "Monthly", "Yes", "Line 25 - Utilities"),
    (date(2026, 2, 12), "Software/SaaS", "Lovable Website Builder", 13.00, "Credit Card", "Monthly", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 2, 20), "Equipment", "Trailer 5x10", 1582.00, "Check", "One-Time", "Yes", "Line 22 - Supplies"),
    (date(2026, 2, 23), "Software/SaaS", "Claude Code", 100.00, "Credit Card", "Monthly", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 2, 24), "Training/Education", "Pearson VUE exam", 45.00, "Credit Card", "One-Time", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 2, 25), "Equipment", "Trailer Hooks", 40.00, "Cash", "One-Time", "Yes", "Line 22 - Supplies"),
    (date(2026, 2, 28), "Software/SaaS", "Lovable Website Builder", 13.00, "Credit Card", "Monthly", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 2, 28), "Equipment", "Monitor (2nd)", 105.00, "Credit Card", "One-Time", "Yes", "Line 22 - Supplies"),
    (date(2026, 3, 1), "Marketing/Advertising", "Yard Signs Uz Marketing", 398.00, "Check", "One-Time", "Yes", "Line 8 - Advertising"),
    (date(2026, 3, 1), "Software/SaaS", "Jobber Subscription", 49.00, "Credit Card", "Monthly", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 3, 5), "Licensing/Permits", "License application fee", 45.00, "Check", "One-Time", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 3, 6), "Marketing/Advertising", "Reviews ($5/per)", 45.00, "Venmo", "One-Time", "Yes", "Line 8 - Advertising"),
    (date(2026, 3, 7), "Insurance", "Pekin Liability Insurance", 86.00, "ACH/Bank", "Annual", "Yes", "Line 15 - Insurance"),
    (date(2026, 3, 7), "Software/SaaS", "Porkbun Domains", 22.00, "Credit Card", "Annual", "Yes", "Line 27a - Other Expenses"),
    (date(2026, 3, 8), "Marketing/Advertising", "1x Google Review", 5.00, "Venmo", "One-Time", "Yes", "Line 8 - Advertising"),
    (date(2026, 3, 9), "Phone/Communications", "Twilio", 20.00, "Credit Card", "Monthly", "Yes", "Line 25 - Utilities"),
    (date(2026, 3, 9), "Phone/Communications", "Quo", 22.01, "ACH/Bank", "Monthly", "Yes", "Line 25 - Utilities"),
]

GAS_DATA = [
    (date(2026, 1, 1), "Car", 35.00),
